...
public class Chinhsua_sv04_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void getstudentbyid()
    {
        ...
        JsonObjectRequest obreg = new JsonObjectRequest(Request.Method.GET,Configpt11304.URL_GET_EMP+id,
                new Response.Listener<JSONObject>()
                {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            JSONArray jsarray =  response.getJSONArray(Configpt11304.TAG_JSON_ARRAY);
                                ...
                                String name = objitem.getString(Configpt11304.TAG_NAME);
                                String masv = objitem.getString(Configpt11304.TAG_MASV);
                                String link = objitem.getString(Configpt11304.TAG_LINK);
                                String DTB = objitem.getString(Configpt11304.TAG_DTB);
...

    {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response)
            {
                ...
                {
                    Toast.makeText(Chinhsua_sv04_Activity.this, "Lỗi cập nhật", Toast.LENGTH_SHORT).show();
                }
